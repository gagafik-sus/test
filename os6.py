...
shell - system shell (bash, fish, zsh)
            ...
            print("|========|")
            time.sleep(0.1)
            print("|AdubamOS|   AdubamOS v0.6r")
            time.sleep(0.1)
            print("|( 0)(0 )|   Adu-Shell v0.3r")
            time.sleep(0.1)
            print("|   --   |   r - release")
            time.sleep(0.1)
            print("|========|   b - beta")
...
`█      eGg      █'
 `█  adubamOS  ▄█'
   ▀▄▄  v0.6 ▄▀'
     ...
     adubamos ester egg v0.6


""")
            egg = input('Easter egg -$ ').strip().lower()
            if egg == "shell":
                shell()
            else:
                print('Я буду разрабатывать easter egg...')
